 ...
 */
export async function verifyPluginSignature(signature: PluginSignature, content: string): Promise<VerificationResult> {
 ...
 */
function verifyWithKey(signature: PluginSignature, publicKey: string, _content: string): VerificationResult {
	// Recreate payload
 ...
 */
export function parseSignatureFromFrontmatter(frontmatter: Record<string, unknown>): PluginSignature | null {
