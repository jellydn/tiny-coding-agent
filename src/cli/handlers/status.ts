...
export async function handleStatus(config: Config, options: StatusHandlerOptions): Promise<void> {
	...
	console.log(`${capabilityCheck("System Prompts", capabilities.supportsSystemPrompt)} System Prompts`);
	console.log(`${capabilityCheck("Tool Streaming", capabilities.supportsToolStreaming)} Tool Streaming`);
