...
async function createSkillFile(skillDir: string, name: string, description: string): Promise<string> {
...
async function createNestedSkill(baseDir: string, subdir: string, name: string, description: string): Promise<string> {
