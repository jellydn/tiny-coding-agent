...
describe("generateSkillsPrompt", () => {
	...
	it("should generate XML for single skill", () => {
		...
		expect(result).toContain(
			"<skill><name>test-skill</name><description>A test skill</description><location>/path/to/skill</location></skill>"
		);
		expect(result).toContain("</available_skills>");
	...
	it("should generate XML for multiple skills", () => {
		...
		expect(result).toContain("<available_skills>");
		expect(result).toContain(
			"<skill><name>skill-one</name><description>First skill</description><location>/path/one</location></skill>"
		);
		expect(result).toContain(
			"<skill><name>skill-two</name><description>Second skill</description><location>/path/two</location></skill>"
		);
		expect(result).toContain(
			"<skill><name>skill-three</name><description>Third skill</description><location>/path/three</location></skill>"
		);
		expect(result).toContain("</available_skills>");
	});
	...
	it("should escape special characters in skill metadata (XML injection protection)", () => {
		...
		expect(result).toContain(
			"<skill><name>my-skill</name><description>A skill with &lt;brackets&gt; &amp; ampersands</description><location>/path/skill</location></skill>"
		);
	});
